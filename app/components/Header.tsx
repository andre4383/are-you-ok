  ...
  return (
    <header className="w-full py-2 px-2 flex">
      ...
      <Link
        ...
        className="inline-block font-bold text-[12pt] text-gray-500 hover:text-black cursor-pointer transition-colors duration-300 ease-in-out selection:bg-black selection:text-white ml-auto"
      >
        github
      </Link>
    </header>
