...
export default function Header() {
  return (
    <header className="w-full py-2 px-2 flex">
      ...
      <h2 className="inline-block font-bold text-16pt text-gray-500 hover:text-black cursor-default transition-colors duration-300 ease-in-out selection:bg-black selection:text-white ml-auto">
        github
      </h2>
    </header>
  );
